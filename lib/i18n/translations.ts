...
export const translations = {
  en: {
    ...
    exercise: {
      ...
      selfCheckPlaceholder: "Write your solution here…",
      selfCheckYourAnswer: "Your attempt:",
      selfCheckModelAnswer: "Model answer:",
  ...
  de: {
    ...
    exercise: {
      ...
      selfCheckPlaceholder: "Schreibe deinen Lösungsweg hier…",
      selfCheckYourAnswer: "Dein Lösungsversuch:",
      selfCheckModelAnswer: "Musterlösung:",
